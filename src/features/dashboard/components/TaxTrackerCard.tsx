...
export function TaxTrackerCard() {
  ...
  return (
    ...
    >
      {data.is_estimate && (
        <p
          className="mb-3 rounded-md border border-warning-300 bg-warning-50 px-2 py-1 text-xs text-warning-800 dark:border-warning-700/60 dark:bg-warning-950/40 dark:text-warning-200"
