  ...
  return (
    <li
      className={`rounded-lg border border-slate-200 p-4 transition-shadow dark:border-slate-800 ${
        isHighlighted ? 'ring-2 ring-accent-400 dark:ring-accent-500' : ''
      }`}
    >
  ...
  return (
    <li className="rounded-lg border border-slate-200 dark:border-slate-800">
      <button
        ...
        aria-expanded={open}
        className="flex w-full items-center justify-between gap-3 rounded-lg px-4 py-3 text-left transition-colors hover:bg-slate-50 focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:outline-none dark:hover:bg-slate-800/40"
      >
  ...
  return (
    <li className="list-none">
      <button
        type="button"
        onClick={onToggle}
        className="w-full rounded-md border border-dashed border-slate-300 bg-slate-50 px-3 py-2 text-sm font-medium text-accent-700 transition-colors hover:bg-accent-50 focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:outline-none dark:border-slate-700 dark:bg-slate-900 dark:text-accent-300 dark:hover:bg-accent-950/40"
      >
