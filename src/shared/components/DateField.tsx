        ...
        {grid.map((cell) => {
          ...
          return (
            <button
              ...
              className={`focus-visible:ring-accent-500 flex h-9 items-center justify-center rounded-md text-sm tabular-nums transition-colors focus-visible:ring-2 focus-visible:outline-none ${dayCellClass(
                isSelected,
                isToday,
                cell.inMonth
              )}`}
    ...
    <div className={`w-full ${className ?? ''}`}>
      <div className="relative">
        ...
        <button
          ...
          tabIndex={-1}
          disabled={disabled}
          className="focus-visible:ring-accent-500 absolute top-1/2 right-1.5 -translate-y-1/2 rounded-md p-1 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-700 focus-visible:ring-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-60 dark:text-slate-500 dark:hover:bg-slate-800 dark:hover:text-slate-200"
        >
